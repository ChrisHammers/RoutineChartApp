 ...
 */
@Singleton
class CompositeFamilyInviteRepository
    @Inject
    constructor(
            ...
            if (isUsedCountIncrement && existingInvite != null) {
                try {
                    ...
                    AppLogger.Database.info(
                        "Incremented usedCount for invite ${invite.id} from ${existingInvite.usedCount} to ${invite.usedCount}",
                    )
                } catch (e: Exception) {
