...
abstract class FirebaseModule {
    @Binds
    @Singleton
    abstract fun bindFamilyRepository(impl: CompositeFamilyRepository): FamilyRepository

    @Binds
    @Singleton
    abstract fun bindFamilyInviteRepository(impl: CompositeFamilyInviteRepository): FamilyInviteRepository

    @Binds
    @Singleton
    abstract fun bindUserRepository(impl: CompositeUserRepository): UserRepository
}
